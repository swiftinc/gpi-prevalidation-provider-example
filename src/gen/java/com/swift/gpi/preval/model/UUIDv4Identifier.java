 ...
 */
@Schema(description = "Universally Unique IDentifier (UUID) version 4, as described in IETC RFC 4122 Universally Unique IDentifier (UUID) URN Namespace.")
public class UUIDv4Identifier   {
  ...
  public String toString() {
    ...
    sb.append("class UUIDv4Identifier {\n");
